...
# pokemon_legendary documentation build
...
from pokemon_legendary import __version__ as release

# -- Project information -----------------------------------------------------

project = "pokemon_legendary"
author = "Kedro"
...
htmlhelp_basename = "pokemon_legendarydoc"
...
latex_documents = [
    (
        master_doc,
        "pokemon_legendary.tex",
        "pokemon_legendary Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "pokemon_legendary",
        "Project pokemon_legendary codebase.",
        "Data-Science",
    )
]
